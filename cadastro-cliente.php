    ...
    if(isset($_GET['id'])){
        ...
        if(mysqli_num_rows($conecta)>0){
            while($row = mysqli_fetch_assoc($conecta)) {
                 ...
                 unset($explode[0]);    
        ?>
        <form id="myForm" class="col s12" action="confirma-cadastro-cliente.php" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col s4">
                                ...
                                <ul id="dropdown4" class="dropdown-content">
                                    ...
                                    <li><a href="#modal18">Tesouras 1.50x1.00</a></li>
            ...
            <div class="input-field col s12 m6 l6">
                ...
                <input id="valor" placeholder="Sub-total" style="color: #333" name="subtotal" value="<?=moedaReal($row['valor'])?>" type="text" class="validate" readonly>
            ...
            <div class="input-field col s6 m4 l6">
                ...
                <input id="totalValor" placeholder="Valor Total" name="valor" value="<?=moedaReal($row['valor'])?>"type="text" class="validate">
            ...
            <div class="input-field col s12 m12 l12">
                ...
                <input id="icon_email" name="obs" value="<?=$row['obs']?><?=(isset($_GET['renovacao'])) ? ' - renovação do comprovante '.$id : '';?>" type="text" class="validate">
                <?php
                    if(isset($_GET['renovacao'])){
                ?>
                    <input name="renovacao" type="hidden" value="<?=$id?>" class="validate">
                <?php            
                    }
                ?>
            ...
            <div class="card-action right-align col s12 m12 l12">
                ...
                <button class="btn waves-effect waves-light" type="submit" id="btnEnviar" name="action">Cadastrar
        ...
        <form id="myForm" class="col s12" action="confirma-cadastro-cliente.php" method="post">
                        ...
                        <div class="input-field col s9 m9 l9">  
                            <select name="andaime" id="cadeirinhas" class="icons">
                                ...
                                <?php
                                    ...
                                    $valorCadeirinha = 260.00;
                                ?>
                                    <option value="<?=$i?>"><?=$i?> Cadeirinha(s) Suspensa(s), <?=$i?> Trava-Quedas, <?=$i?> Cinto(s) de Segurança - R$ <?=($i*$valorCadeirinha)?></option>
                                <?php
                                    }
                                ?>
                            </select>
            ...
            <div class="input-field col s6 m4 l3">
                <i class="material-icons prefix">date_range</i>
                <input id="entrega" name="entrega" type="text" class="datepicker">  
            </div>
            <div class="input-field col s6 m4 l3">
                <input id="retirada" name="retirada" type="text"  class="datepicker">
            </div>
            <div class="input-field col s6 m4 l6">    
                <input style="color: #333" id="diasCorridos" type="text" name="diasCorridos" disabled />
                <!--<a  class="btn-flat disabled"></a>-->
            </div>    
            ...
            <div class="input-field col s12 m12 l12">
                <i class="material-icons prefix">map</i>         
                <center>
                    <input id="txtEndereco" style="background-color: #fff; padding-left: 15px;" name="txtEndereco" class="controls" type="text" placeholder="Digite o endereço aqui">
                    <div id="type-selector" class="controls">
                      <input type="radio" name="type" id="changetype-all" checked="checked">
                      <label for="txtEndereco">Endereço</label>
                    </div>
            ...
            <div class="input-field col s12 m6 l6">
                <i class="material-icons prefix">attach_money</i>
                <input id="valor" placeholder="Sub-total" style="color: #333" name="subtotal" type="text" class="validate" disabled>
                <label for="valor">Sub-total</label>
            </div>
            <div class="input-field col s12 m6 l6">
                <i class="material-icons prefix">local_shipping</i>
                <input id="frete" placeholder="Valor Frete" style="color: #333" name="frete" type="text" disabled>
                <label for="frete">Frete</label>
            </div>
            <div class="input-field col s6 m4 l6">
                <i class="material-icons prefix">monetization_on</i>
                <input id="totalValor" placeholder="Valor Total" name="valor" type="text" class="validate">
                <label for="totalValor">Valor Total</label>
            </div>
            <div class="input-field col s12 m6 l6"> 
                <i class="material-icons prefix">credit_card</i>
            ...
            <div class="input-field col s12 m12 l12">
                <i class="material-icons prefix">account_circle</i>
                <input placeholder="Nome Completo" type="text" name="nome" id="nome" class="autocomplete">
                <label for="nome">Nome Completo</label>
            </div>
            <div class="input-field col s12 m16 l6">
                <i class="material-icons prefix">fingerprint</i>
                <input placeholder="CPF ou CNPJ" id="registro" name="registro" type="text" class="validate" onblur="trueCNPJ(this.value)">
                <label for="registro">Registro</label>
            </div>
            <div class="input-field col s12 m6 l6">
                <i class="material-icons prefix">contact_mail</i>
            ...
            <div class="input-field col s4 m2 l2">
                <i class="material-icons prefix">phone</i>
                <input placeholder="DDD" id="ddd" name="ddd" value="21" type="tel" class="validate">
                <label for="ddd">DDD 1</label>
            </div>
            <div class="input-field col s8 m4 l4">
                <input placeholder="Telefone" id="telefone" name="telefone" type="tel" class="validate">
                <label for="telefone">Telefone 1</label>
            </div>
            <div class="input-field col s4 m2 l2">
                <i class="material-icons prefix">phone</i>
                <input placeholder="DDD" id="ddd2" name="ddd2" value="21" type="tel" class="validate">
                <label for="ddd2">DDD 2</label>
            </div>
            <div class="input-field col s8 m4 l4">
                <input placeholder="Telefone" id="telefone2" name="telefone2" type="tel" class="validate">
                <label for="telefone2">Telefone 2</label>
            </div>
            <div class="col s12 m12 l12">
                <h3 class="flow-text">Dados da Entrega</h3>
            ...
            <div class="input-field col s12 m6 l6"> 
                ...
                <select name="vendedor" class="icons">
                    ...
                    <option value="1" data-icon="https://scontent.fgig4-1.fna.fbcdn.net/v/t1.0-9/15672988_1397210570311300_7817001615576703992_n.jpg?oh=bf809e999130628e1d495e145b3bbc45&oe=598877D7" class="left circle">Clayton Soares</option>
                    <option value="2" data-icon="https://scontent.fgig4-1.fna.fbcdn.net/v/t1.0-9/15109526_202015303588681_5649696194015475996_n.jpg?oh=4fd343c591a77cdf5177505bd5399dbd&oe=5999AED1" class="left circle">Sandra Lessa</option>
                    <option value="3" data-icon="https://scontent.fgig4-1.fna.fbcdn.net/v/t1.0-9/14330138_132227710567441_3524928093993711998_n.jpg?oh=692cf629529852f457a5bcb198e615cf&oe=594DDA5B" class="left circle">Antônio Sergio</option>
                    <option value="4" data-icon="https://scontent.fgig4-1.fna.fbcdn.net/v/t1.0-9/13631501_1051127964922772_8060052909830460409_n.jpg?oh=e2d01b5e4a399e57a80670143b1fa49a&oe=5997B2E5" class="left circle">Vinícius Soares</option>
                </select>
                <label>Vendedor</label>            
            </div>
            <div class="card-action right-align col s12 m12 l12">
